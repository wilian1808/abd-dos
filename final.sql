-- consideres la siguiente base de datos relacional
...
-- Las restricciones ( check ) en la definición de las tablas anteriores deben garantizar:
-- a) que cada empleado trabaje para una empresa ubicada en su ciudad de residencia.
-- b) que ningún empleado gane un sueldo mayor que el de su jefe.

-- sql server
-- se reestructuro un poco la base de datos
-- para un mejor manejo y relacionado de los datos

-- DROP DATABASE IF EXISTS ejemplo_dos;
-- GO

-- CREATE DATABASE IF NOT EXISTS ejemplo_dos;
-- GO
